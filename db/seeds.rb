...
john_cart = Cart.create(quantity: nil, user_id: john.id)
jonathan_cart = Cart.create(quantity: nil, user_id: jonathan.id)

cart_item1 = CartItem.create(cart_id: john_cart.id, item_id: item1.id)
cart_item2 = CartItem.create(cart_id: john_cart.id, item_id: item2.id)
cart_item3 = CartItem.create(cart_id: john_cart.id, item_id: item3.id)
cart_item4 = CartItem.create(cart_id: john_cart.id, item_id: item4.id)
cart_item5 = CartItem.create(cart_id: john_cart.id, item_id: item5.id)
cart_item6 = CartItem.create(cart_id: jonathan_cart.id, item_id: item6.id)
cart_item7 = CartItem.create(cart_id: jonathan_cart.id, item_id: item7.id)
cart_item8 = CartItem.create(cart_id: jonathan_cart.id, item_id: item1.id)
cart_item9 = CartItem.create(cart_id: jonathan_cart.id, item_id: item2.id)
cart_item0 = CartItem.create(cart_id: jonathan_cart.id, item_id: item3.id)
